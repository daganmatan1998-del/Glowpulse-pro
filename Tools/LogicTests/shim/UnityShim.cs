...
namespace UnityEngine
{
    ...
    /// <summary>
    /// Only the keys the project actually binds. The real enum has hundreds of
    /// members; the binding table only ever names these, and a short list keeps
    /// the shim honest about what is really being tested.
    /// </summary>
    public enum KeyCode
    {
        None = 0,
